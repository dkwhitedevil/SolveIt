...
import questionsData from '../Questions/clim.json'; // Ensure this path is correct
...
const ClimateEnvironmentScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Climate and Environment - Quiz</Text>
      </View>
...
export default ClimateEnvironmentScreen;
