...
import questionsData from '../Questions/fit.json'; // Ensure this path is correct
...
const HealthFitnessScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Health and Fitness - Quiz</Text>
      </View>
